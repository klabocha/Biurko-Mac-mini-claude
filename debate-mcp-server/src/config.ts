...
import type { ModelConfig, DebateConfig, ServerConfig } from "./types.js";
...
const DEFAULT_MODELS: Record<string, Omit<ModelConfig, "apiKey"> & { apiKeyEnv: string }> = {
  claude: {
    provider: "anthropic",
...
export function removeModelFromConfig(config: ServerConfig, name: string): boolean {
